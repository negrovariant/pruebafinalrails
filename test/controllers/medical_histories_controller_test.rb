...
class MedicalHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_history" do
    assert_difference("MedicalHistory.count") do
      post medical_histories_url, params: { medical_history: { appointment_id: @medical_history.appointment_id, content: @medical_history.content, pet_id: @medical_history.pet_id } }
    end
  ...
  test "should update medical_history" do
    patch medical_history_url(@medical_history), params: { medical_history: { appointment_id: @medical_history.appointment_id, content: @medical_history.content, pet_id: @medical_history.pet_id } }
